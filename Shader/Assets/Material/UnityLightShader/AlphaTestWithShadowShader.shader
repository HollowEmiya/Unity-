Shader "Custom/AlphaTestWithShadowShader"
{
    Properties
    {
        ...
        _Cutoff("Alpha Cutoff", Range(0,1)) = 0.5   //  Alpha test control
    }
    SubShader
    {
        ...
        Pass{
            ...
            sampler2D _MainTex;
            float4 _MainTex_ST;
            fixed _Cutoff;              // close behind cut off
            ...
            struct v2f{
                ...
                float3 worldPos : TEXCOORD1;        // TEXCOORD1
                float2 uv : TEXCOORD2;              // TEXCOORD2
